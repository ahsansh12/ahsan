            ...
            <div class="col-sm-3">
                <div class="sub-total border text-center mt-2">
                    ...
                    <div class="border-top py-4">
                        ...
                        <button type="submit" class="btn btn-warning mt-3" onclick="document.location='payment.php'" >Proceed to Buy</button>
                    </div>
                </div>
            </div>
            <!-- !subtotal section-->
...
<!-- !Shopping cart section  --><?php echo count($product->getData('cart')); ?>